...
#SBATCH --ntasks-per-node=12            ## number_of_cores
...
mpiexec -n 12 python3 -m mpi4py ISIMIP3a_Step01_Download_forcings.py --mca btl_openib_allow_ib 1 > ISIMIP3a_Step01_Download_forcings.log
